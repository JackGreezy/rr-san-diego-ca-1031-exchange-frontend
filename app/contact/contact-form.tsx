...
function ContactForm() {
  ...
  return (
    <div id="contact-form" className="scroll-mt-28 rounded-2xl border border-white/25 bg-brand-charcoal/50 p-5 shadow-2xl sm:p-8">
...
export function ContactFormWrapper() {
  return (
    <Suspense fallback={<div className="rounded-2xl border border-white/25 bg-brand-charcoal/50 p-5 text-white/85 sm:p-8">Loading form...</div>}>
      <ContactForm />
    </Suspense>
  );
}
